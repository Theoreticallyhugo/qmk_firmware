...
void render_layer_state(void) {
    ...
    static const char PROGMEM gayming_layer[] = {
        0x20, 0x9d, 0x9e, 0x9f, 0x20,
        0x20, 0xbd, 0xbe, 0xbf, 0x20,
        0x20, 0xdd, 0xde, 0xdf, 0x20, 0};
    ...
    } else if(layer_state_is(_GAYMING)) {
        oled_write_P(gayming_layer, false);
    } else {
...
// this is overriding our proper config in the keymap, so its commented out
//
