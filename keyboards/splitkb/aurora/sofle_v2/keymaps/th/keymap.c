...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(KC_GRV               , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                         KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS,
                 ...
                 OSM(MOD_LSFT)        , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_MUTE,       _______, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, OSM(MOD_RSFT),
                                                 KC_LCTL, KC_ENT , KC_LALT, MO(2)  , KC_LGUI, OSM(MOD_RALT), KC_SPC , MO(1)  , KC_BSPC, KC_ROPT),
	...
	[1] = LAYOUT(_______   , KC_F1     , KC_F2  , KC_F3    , KC_F4    , KC_F5  ,                   KC_F6   , KC_F7  , KC_F8  , KC_F9  , KC_F10    , KC_F11 ,
                 ...
                 KC_NUBS   , S(KC_NUBS), KC_EQL , S(KC_EQL), RSA(KC_7), RALT(KC_5), KC_MPLY, XXXXXXX, RALT(KC_6) , RALT(KC_7), RALT(KC_8), RALT(KC_9), S(KC_NUHS), KC_NUHS,
                                         _______,   _______, KC_RALT  , MO(3)  , _______, XXXXXXX, _______ , XXXXXXX, XXXXXXX, XXXXXXX),
	...
	[2] = LAYOUT(_______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
                 ...
                 _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, XXXXXXX, _______, KC_H   , KC_J   , KC_L   , KC_K   , _______, _______,
                                   XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, KC_ENT , MO(3)  , _______, _______),

    // SYSTEM CONTROL
    // control music, volume, sleep and the mouse
    // first row switch unicode input to the respective OS
	[3] = LAYOUT(DF(4)  , _______, _______, _______, _______, KC_SLEP,                   _______, _______, _______, _______, _______, _______,
	             _______, _______, _______, _______, _______, _______,                   KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_ACL0, _______,
	             KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE, KC_VOLU,                   KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_ACL1, KC_ACL2,
	             _______, _______, _______, _______, _______, _______, XXXXXXX, KC_PWR , _______, KC_BTN1, KC_BTN2, _______, _______, _______,
                                   XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX),

    // GAYMING
	[4] = LAYOUT(KC_ESC , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                   KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS,
                 KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,                   KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC,
                 KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,                   KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
                 KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_MUTE, _______, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                                   KC_LOPT, KC_ENT , KC_LALT, KC_SPC , KC_LGUI, KC_RALT, KC_SPC , MO(1)  , KC_BSPC, DF(0) ),
};
